...
SECRET_KEY = 'fzm64i%j_dss899oes*#f2s%%$u=o3+pr=otm4t_bjlhq#fo2y'
...
DATABASES = {'default':{'ENGINE':'django.db.backends.sqlite3','NAME':os.path.join(BASE_DIR+'/data','db.sqlite3'),}}
